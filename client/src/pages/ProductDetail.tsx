...
> = {
  "femto-ldv-z8": {
    ...
    content: [
      ...
      "Система поддерживает широкий спектр процедур, включая LASIK, SMILE, CLEAR, операции по удалению катаракты и кератопластику. Программируемые разрезы позволяют хирургу создавать индивидуальные параметры для каждого пациента.",
