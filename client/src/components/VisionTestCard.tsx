...
import { Eye, Grid3x3, Palette, Target, Contrast, ScanEye } from "lucide-react";

interface VisionTestCardProps {
  title: string;
  description: string;
  icon: "eye" | "grid" | "palette" | "target" | "contrast" | "scan_eye";
  testId: string;
}
...
export default function VisionTestCard({
  title,
  description,
  icon,
  testId,
  ...
  return (
    <Card
      className="group p-6 hover-elevate transition-all duration-300 cursor-pointer"
